...
export type CompanyId = "institute" | "chennai" | "ttpune" | "subhags" | "nulite" | "wolff";
...
export const brand = {
  ...
  established: 1998,
  yearsLegacy: "25+",
  countries: ["India", "Dubai", "Germany"] as const,
  cities: ["Pune", "Mumbai", "Chennai", "Dubai", "Hamburg"] as const,
  companyCount: 6,
  group: {
...
export const companies: Record<CompanyId, Company> = {
  ...
  ttpune: {
    ...
    code: "CO · 02",
    discipline: "MARINE REPAIR",
    name: "Torque Techniques Pune",
    shortName: "Torque Techniques Pune",
    role: "Shipboard Hydraulic Repair Workshop · Pune",
    city: "Pune",
    country: "IN",
    blurb: "Shipboard hydraulic repair workshop and marine maintenance.",
    body:
  ...
  nulite: {
    ...
    chips: [
      ...
      { label: "FOCUS",    value: "Safety System" },
      { label: "SCOPE",    value: "Various Industries" },
    ],
...
export const companyOrder: CompanyId[] = [
  "subhags", "ttpune", "institute", "chennai", "nulite", "wolff",
];
...
export const home = {
  hero: {
    ...
    body:
      "A multi-company maritime engineering holding group operating manufacturing infrastructure, marine repair workshops, technical training systems and industrial engineering services across India, Dubai and Germany.",
    ctas: [
    ...
    stats: [
      ...
      { num: "06",  label: "Group Companies"   },
      { num: "05",  label: "Operational Cities" },
    ],
  ...
  ecosystem: {
    ...
    parent: {
      ...
      title:   "TORQUE GROUP",
      body:
        "Maritime engineering holding company coordinating manufacturing, marine services, training and industrial systems across six specialised companies.",
      badges: ["EST · 1998", "IN · DE · AE"],
    },
  },
  ...
  overview: {
    ...
    metrics: [
      ...
      { num: "06",   label: "Companies",    desc: "Specialised engineering companies under one group." },
      { num: "03",   label: "Countries",    desc: "India, Dubai and Germany operational footprint." },
      { num: "100+", label: "Employees",    desc: "Engineers and technicians across the group." },
  ...
  clients: {
    ...
    body:
      "A working roster of marine, shipbuilding, offshore and industrial customers across India, Dubai and overseas.",
  },

  global: {
    eyebrow: "GLOBAL PRESENCE",
    h2: "Operational across India, Dubai and Germany",
    offices: [
      { code: "CO · 01", city: "Pune · India",       desc: "Group head office, Subhag Engineers pump manufacturing and Torque Techniques Pune hydraulic repair." },
      { code: "CO · 03", city: "Mumbai · India",     desc: "Torque Technics Institute — marine technical training infrastructure." },
      { code: "CO · 04", city: "Chennai · India",    desc: "Torque Technics Chennai — shipboard hydraulic repair workshop." },
      { code: "—",       city: "Dubai · UAE",        desc: "Regional service and sales presence for Gulf maritime operations." },
      { code: "CO · 06", city: "Hamburg · Germany",  desc: "Armaturen-Wolff LLP — maritime valve engineering operations." },
    ],
    pins: [
      ...
      { id: "dubai",   label: "DUBAI · AE",   lat: 25.20, lng: 55.27 },
    ],
  },
...
export const about = {
  head: {
    ...
    lede:
      "Torque Group operates as the parent of six specialised maritime engineering companies, each with its own operating heritage. Together they form a single industrial ecosystem covering manufacturing, marine services, training and engineering execution.",
  },
    ...
    members: [
      {
        ...
        bio:
          "Marine Engineer Officer Class I (Ch. Engr.) and ISO 9001:2015 Lead Auditor of sea service with 17+ years experience. Co-founder of the group, leading marine training, dredger technical management and IMO-compliant marine equipment. Government-licensed surveyor and long-serving Chairman of the Institute of Marine Engineers, Pune Branch.",
      ...
      {
        role: "CO-FOUNDER · CHIEF ENGINEER MARINE (MEO CLASS-I)",
        name: "Mr. Gurunathan.M",
        title: "Co-founder · Chief Engineer Marine",
        summary:
          "Chief Engineer Marine (MEO Class-I) — marine hydraulic systems specialist.",
        bio:
          "Chief Engineer Marine who has served on bulk carriers, tankers, ro-ro vessels and passenger ships. Chief Engineer Marine (MEO Class-I) with experience in ship operation & maintenance, shore-based technical fleet management and shipbuilding. Specialises in marine hydraulic systems — troubleshooting, training, maintenance, reconditioning and reverse engineering for obsolete spares — leading a team of hydraulic service engineers deploying and providing solutions across the globe for the last 15 years.",
        photo: "/images/team/gurunathan.png",
      },
      {
        role: "CO-FOUNDER · CHIEF ENGINEER MARINE (MEO CLASS-I)",
        name: "Mr. Gurumurthi.K",
        title: "Co-founder · Chief Engineer Marine",
        summary:
          "Chief Engineer Marine (MEO Class-I) — marine hydraulic systems specialist.",
        bio:
          "Chief Engineer Marine (MEO Class-I) with industrial experience in the manufacturing sector, ship operation & maintenance and shore-based technical management of fleets. Specialises in marine hydraulic systems — troubleshooting, training, maintenance, reconditioning and reverse engineering for obsolete spares — leading a team of hydraulic service engineers deploying and providing solutions across the globe for the last 15 years.",
        photo: "/images/team/gurumurthi.png",
      },
    ],
  },
  ...
  philosophy: {
    ...
    badges: ["EST · 1998", "ENGINEER-LED", "CLASS-ALIGNED"],
  },
  ...
  milestones: {
    ...
    h2: "Group evolution",
    items: [
      { year: "1991", title: "Subhag Engineers founded",          desc: "Marine pump manufacturing operation established in Pune." },
      { year: "1998", title: "Torque Techniques Pune",            desc: "Shipboard hydraulic repair workshop established in Pune." },
  ...
  corridor: {
    ...
    h2: "India ↔ Dubai ↔ Germany",
    body:
      "The group operates a working corridor between Indian manufacturing & service scale, Gulf regional reach in Dubai and German maritime valve engineering. The three sides share specifications, drawings and approvals — keeping product output internationally consistent.",
  },
} as const;
...
export const companiesPage = {
  head: {
    ...
    eyebrow: "SIX COMPANIES · ONE ECOSYSTEM",
    h1: "Group Companies",
    lede:
...
export const infrastructure = {
  head: {
    ...
    lede:
      "Across Pune, Mumbai, Chennai, Dubai and Hamburg the group operates a combined footprint of manufacturing floors, hydraulic workshops, marine training labs and engineering execution facilities.",
  },
  metrics: [
    { num: "100+", label: "Employees"      },
    { num: "05",   label: "Cities"         },
    { num: "05",   label: "Facilities"     },
  ...
  equipment: {
    ...
    h2: "Selected workshop equipment",
    rows: [
      { equipment: "Turbocharger overhaul bay", company: "Torque Technics Institute",   location: "Mumbai",  use: "Training / Service" },
      { equipment: "Marine pump test rig",      company: "Subhag Engineers",           location: "Pune",    use: "Pressure / Flow Test" },
      { equipment: "Purifier overhaul workshop", company: "Torque Technics Institute",  location: "Mumbai",  use: "Training" },
      { equipment: "Hydraulic cylinder honing", company: "Torque Technics Chennai",    location: "Chennai", use: "Repair" },
      { equipment: "Engine-room simulator",     company: "Torque Technics Institute",   location: "Mumbai",  use: "Cadet Training" },
      { equipment: "CNC machining centre",      company: "Subhag Engineers",           location: "Pune",    use: "Pump Components" },
      { equipment: "Valve test bench",          company: "Armaturen-Wolff LLP",        location: "Hamburg", use: "QC / Certification" },
    ],
  },
} as const;
...
export const industries = {
  ...
  sectors: [
    ...
    { code: "SECTOR · 06", title: "Skill upgradation for pre-sea and post-sea", desc: "Pre-sea and post-sea practical training and skill-upgradation programmes with workshop and simulator infrastructure." },
  ],
  matrix: {
  ...
  workflow: {
    ...
    steps: [
      ...
      { code: "FLOW · 02", title: "Engineering",     desc: "Drawings, schematics and Bill of material produced across companies." },
      { code: "FLOW · 03", title: "Manufacturing",   desc: "Pumps (Subhag Engineers), valves (Armaturen-Wolff), signage (Nulite) sourced in-group." },
      { code: "FLOW · 04", title: "Execution",       desc: "Workshop fabrication and shipboard installation by Torque Techniques Pune and Chennai field teams." },
...
export const footer = {
  ...
  cols: {
    brand: {
      desc:
        "A maritime engineering holding group operating manufacturing, marine services, technical training and industrial systems across India, Dubai and Germany since 1998.",
    },
    companies: {
      h4: "Companies",
    ...
    offices: {
      h4: "Offices",
      desc1: "Pune · Mumbai · Chennai · Dubai · Hamburg\nOperations across 5 cities, 3 countries.",
...
export const seo: Record<string, RouteMeta> = {
  "/": {
    title: "Torque Group — Maritime Engineering Holding · India, Dubai & Germany",
    description:
      "Maritime engineering holding group operating marine pump manufacturing, valve engineering, technical training, hydraulic repair and IMO safety systems across India, Dubai and Germany since 1998.",
  },
  "/about": {
    title: "About Torque Group — 25+ Years in Maritime Engineering",
    description:
      "Engineer-led maritime holding group operating six specialised companies across India, Dubai and Germany. Founded 1998. IRS · IACS · DIN · IMO aligned.",
  },
  "/companies": {
    title: "Group Companies — Torque Group",
    description:
      "Six maritime engineering companies under Torque Group: pump manufacturing (Subhag Engineers), hydraulic repair (Torque Techniques Pune & Chennai), valve engineering (Armaturen-Wolff), marine training (Institute), IMO signage (Nulite).",
  },
  "/infrastructure": {
  ...
  "/industries": {
    ...
    description:
      "Marine pumps, valves, hydraulics, IMO signage and technical training serving merchant fleets, shipyards, offshore operators and industrial plants across India, Dubai and Germany.",
  },
  "/contact": {
